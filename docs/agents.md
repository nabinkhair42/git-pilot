...
- Write tools (repo-scoped, need approval): `createBranch`, `deleteBranch`, `cherryPickCommits`, `revertCommits`, `resetBranch`, `createOrUpdateFile`, `deleteFile`, `createRelease`, `deleteRepository`.
