...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-2xl group-[.is-user]:bg-secondary group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground group-[.is-user]:shadow-sm group-[.is-user]:ring-1 group-[.is-user]:ring-border/60",
